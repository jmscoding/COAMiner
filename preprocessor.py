...
class ClassPreprocessor:
    def __init__(
        ...
        lemmatize=False,
        remove_newline_or_tab=False,
        remove_unwanted_tokens=False,
        ):
        """
        ...
        self._remove_newline_or_tab=remove_newline_or_tab
        self._remove_unwanted_tokens=remove_unwanted_tokens
    ...
    # if only one text to preprocess
    ...
    def __clean(self, doc: Doc) -> str:
        ...
        if self._remove_unwanted_tokens:
            tokens = [
                token
                for token in tokens
                if not (
